                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="card-body">
                            ...
                            <form action="{{action('CityController@store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                                <div class="form-group has-success">
                                    <label class="control-label mb-1">Name</label>
                                    <input placeholder="Enter city name" name="name" type="text" class="form-control cc-name valid" data-valueMissing="Please enter a name." required>
                                </div>
