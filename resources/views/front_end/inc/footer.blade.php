        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                ...
                <div class="footer-widget">
                    ...
                    <p class="mb10">A reliable partner in your momentous moment, we ensure a seamless and well-executed event so you can focus on what is important.</p>
                    <p>Developing lasting friendships.</p>
                </div>
            </div>
            <!-- /.footer-widget -->
            <!-- footer-widget -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="footer-widget">
                    ...
                    <p>4998 Elk Creek Road Canton,
                        <br> GA 30114</p>
                    <p class="mb0 text-default">+92-300-1234-123</p>
            ...
            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-6 col-12">
                <div class="footer-widget">
                    ...
                    <a href="{{action('Vendor_Dashboard\VdvendorController@index')}}" class="btn btn-default">List your Business</a>
                </div>
            </div>
            <!-- /.footer-widget -->
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right">
                <p>© 2019 Events Bash. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</div>
