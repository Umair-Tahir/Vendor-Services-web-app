                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="vendor-thumbnail" >
                                ...
                                <div class="vendor-img zoomimg">
                                    <!-- Vendor img -->
                                    <a href="{{action('Front_End\FeServiceController@show',[$blog->title])}}"><img src="/upload-images/{{$blog->image}}" style="width:340px;height:240px;" alt="" class="img-fluid"></a>
                                </div>
                                <!-- /.Vendor img -->
                                <div class="vendor-content">
                                    <!-- Vendor Content -->
                                    <h2 class="vendor-title"><a href="{{action('Front_End\FeServiceController@show',[$blog->title])}}" class="title">{{$blog->title}}</a></h2>
                                    <p class="vendor-address">{{$blog->user->username}}</p>
                                </div>
                ...
                @else
                    <div class="error-block">
                        <div class="error-content">
                            ...
                            <h2 class="error-second-title">No Blogs Found</h2>
