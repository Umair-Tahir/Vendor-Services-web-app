                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title">Edit Service</h3>
                            <p>Creating service let you start and expand your business.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header"> <h4 class="mb0">Edit Service</h4></div>
                    <div class="">
                        <div class="example-form example-form_after">
                        <form action="{{action('Vendor_Dashboard\VdserviceController@update', $service->id)}}" method="post" enctype="multipart/form-data">
                          @method('Put')
                            @csrf
                            <!-- Form Name -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="title" name="title" type="text" value="{{$service->title}}" class="form-control" data-valueMissing="Please enter a title." required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="12" id="description" name="description" placeholder="Enter Description" class="form-control" data-valueMissing="Please enter your description." data-valueMissing="Please service description." required>{{$service->description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
